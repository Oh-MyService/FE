                ...
                <div className="flex flex-row justify-center">
                    <div className="w-[85%]">
                        ...
                        <textarea
                            ...
                            className="appearance-none block w-full h-40 bg-gray-200 text-gray-700 border border-gray-200 rounded py-4 px-4 leading-tight focus:outline-none focus:bg-gray-200 focus:border-gray-500 placeholder-top"
                            placeholder="ex) cat"
                        />
