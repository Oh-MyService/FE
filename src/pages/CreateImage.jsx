...
const CreateImage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const finalNegativePrompt =
      negativePrompt === '' ? 'not_exist' : negativePrompt;
    ...
    try {
      ...
      formData.append(
        'seed',
        isRandomSeed ? Math.floor(Math.random() * 10000) : seed || 0
      );
        ...
        <div className="flex flex-col w-1/2 px-4 mt-10">
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="flex items-center mb-6">
              {/* 색상 선택 */}
              <label className="text-lg font-['pretendard-bold'] mr-4">
                색상
              </label>
              <select
            ...
            <div className="flex mb-6 items-center">
              <label className="mr-4 text-lg font-['pretendard-bold']">
                가로 X 세로
              </label>
              <select
