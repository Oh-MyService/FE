        ...
        <div className="flex min-h-screen bg-[#F2F2F2] pt-10 pb-10 w-full">
            <div className="flex flex-col pt-16 w-full">
                <div className="flex flex-row justify-center">
                    <div className="w-[85%]">
                        <span className="block text-2xl font-['pretendard-extrabold'] text-left text-slate-700 mb-5">
                            상상 속 패턴을 지금 만들어보세요!
                        </span>
                        <textarea
                            type="text"
                            ...
                            className="appearance-none block w-full h-40 bg-gray-200 text-gray-700 rounded py-4 px-4 leading-tight focus:outline-none border-3 border-gray-300"
                ...
                {results.map((result, index) => (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-4 gap-6 mt-8">
                            {[...Array(4)].map((_, i) => (
                                <div key={i} className="flex flex-col justify-between items-center w-60 ml-10">
                                    {imageURL && (
