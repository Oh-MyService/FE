            ...
            <div className="flex flex-col mx-0 my-auto w-full lg:w-2/3 p-4">
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <div className="flex-1">
                        <span className="block text-lg font-bold text-left text-slate-700">프롬프트 작성</span>
                        <input
                            type="text"
                            value={inputText}
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                className="mt-2 sm:mt-4 bg-[#3A57A7] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
                ...
                {imageURL && <img id="image" src={imageURL} alt="Fetched Image" className="mt-4 max-w-xs" />}
=======
  return (
    <div className="flex flex-wrap justify-center items-center p-4 bg-gray-100 min-h-screen">
      <div className="flex flex-col mx-0 my-auto w-full lg:w-2/3 p-4">
...
>>>>>>> 4c4bdadca62467b5f8b984619224459fe91102aa
            </div>
          </div>
          <div className="flex-1">
            <span className="block text-lg font-bold text-left text-slate-700">
