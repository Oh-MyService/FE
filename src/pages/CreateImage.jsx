            ...
            <div className="flex flex-col mx-0 my-auto w-full lg:w-2/3 p-4">
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <div className="flex-1">
                        <span className="block text-lg font-bold text-left text-slate-700">Pattern Generator</span>
                        <input
                            type="text"
                            value={inputText}
                    ...
                    <div className="flex-1">
                        <span className="block text-lg font-bold text-left text-slate-700">Option</span>
