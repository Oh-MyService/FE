...
const CreateImage = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-neutral-300 min-h-screen w-full">
      <div className="flex flex-col top-0 pt-16 w-full">
        ...
        <div className="flex flex-row justify-center mt-20" ref={promptRef}>
          <div className="w-[85%]">
