...
const CreateImage = () => {
  ...
  return (
    <div className="flex justify-center items-center p-4 bg-gray-100 min-h-screen">
      <div className="flex flex-col p-4 w-[85%] absolute inset-0 top-0 pt-20">
        ...
        {showResult && (
          <div className="flex flex-col justify-center mt-4 bg-gray-200 w-[80%] mx-auto p-6 rounded-lg">
