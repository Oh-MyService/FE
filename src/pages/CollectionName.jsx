                        ...
                        {images.map((image, index) => (
                            ...
                            >
                                <img
                                    ...
                                    onClick={() => showFullScreenImage(`data:image/jpeg;base64,${image.image_data}`)} // 이미지 클릭 시 전체 화면으로 보기
                                />
                                <div className="flex justify-between items-center w-full mt-2 text-gray-600">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <button
                                            onClick={
                                                (e) => handleSaveImage(`data:image/jpeg;base64,${image.image_data}`, e) // 이미지 저장 기능 호출
                                            }
                                            className="focus:outline-none"
                                        >
                                            <svg
