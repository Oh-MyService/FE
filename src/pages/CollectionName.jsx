...
const CollectionName = () => {
    ...
    const handleSaveImage = async (imageUrl, e) => {
        ...
        try {
            ...
            link.download = imageUrl.split('/').pop(); // 파일 이름을 추출합니다.
            ...
            <div className="container mx-auto px-4 pt-24">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 mt-8">
                    {collections.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-center w-full mt-2 text-gray-600">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <button onClick={openAddModal} className="focus:outline-none">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                        ...
                                        <button
                                            onClick={(e) => handleSaveImage(collection.images[0], e)}
                                            className="focus:outline-none"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p className="text-xl text-center col-span-6">저장된 패턴이 없습니다.</p>
                    )}
                </div>
                {fullScreenImage && (
                    <div
