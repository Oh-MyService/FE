    ...
    return (
        <div className="bg-[#F2F2F2] min-h-screen">
            <div className="container mx-auto px-4 pt-24">
                        ...
                        {images.map((image, index) => (
                            ...
                            >
                                <img
                                    ...
                                    onClick={() => showFullScreenImage(`data:image/jpeg;base64,${image.image_data}`)}
                                />
                                <div className="flex justify-between items-center w-full mt-2 text-gray-600">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <button
                                            onClick={(e) =>
                                                handleSaveImage(`data:image/jpeg;base64,${image.image_data}`, e)
                                            }
                                            className="focus:outline-none"
                                        >
                                            <svg
                ...
                {isAddModalOpen && (
                    <CollectionAddModal onClose={closeAddModal} resultId={images[addCollectionIndex].id} />
                )}
            </div>
        </div>
    );
