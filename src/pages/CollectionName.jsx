...
const CollectionName = () => {
    ...
    useEffect(() => {
        const fetchCollectionDetails = async () => {
            try {
                // 1. 유저의 모든 컬렉션 불러오기
                const collectionsResponse = await fetch(`http://118.67.128.129:28282/api/collections/user/${userId}`, {
                    method: 'GET',
                    headers: {
            ...
            <div className="container mx-auto px-4 pt-24">
                <div className="flex justify-between items-center py-4">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-3xl font-['pretendard-extrabold']">{collectionName}</h1>
                        <button
                            onClick={(e) => {
                                e.stopPropagation();
                        ...
                        {images.map((image, index) => (
                            ...
                            >
                                <img
                                    ...
                                    onClick={() => showFullScreenImage(image.image_data, image.id)} // 이미지 클릭 시 전체 화면으로 보기
                                />
