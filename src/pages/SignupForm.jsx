...
const SignupForm = ({ onRegisterSuccess, onSwitchToLogin }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-full">
            ...
            <h2 className="text-2xl font-['pretendard-bold'] text-center mb-8 text-black">회원가입</h2>
            <form onSubmit={handleRegister} className="flex flex-col items-center justify-center gap-4">
                <div>
                    ...
                    {usernameErrorMessage && (
                        <p className="text-red-500 font-['pretendard-medium'] text-sm mt-1">{usernameErrorMessage}</p>
                    )}
                </div>
                <div>
                    <input
                ...
                <div>
                    ...
                    {passwordErrorMessage && (
                        <p className="text-red-500 font-['pretendard-medium'] text-sm mt-1">{passwordErrorMessage}</p>
                    )}
                </div>
                <button
                    type="submit"
