...
const EditModal = ({ isOpen, onClose, onEdit }) => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl text-white font-['pretendard-extrabold'] mb-4">
        Edit Collection
      </h2>
      <form onSubmit={handleEdit}>
        ...
        <button
          type="submit"
          className="mt-7 bg-[#303030] hover:bg-gray-800 text-white py-2 px-16 rounded-full mx-auto block font-['pretendard-semibold']"
        >
          Edit
        </button>
      </form>
